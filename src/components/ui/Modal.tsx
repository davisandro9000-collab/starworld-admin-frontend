      ...
      {open && (
        <>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 overflow-y-auto">
            <motion.div
              className={cn('glass rounded-2xl w-[90vw] shadow-2xl flex flex-col my-8', maxWidth, className)}
            ...
            >
              ...
              {hideTitle && (
                <button onClick={onClose} className="absolute top-3 right-3 text-white/30 hover:text-white z-10 text-lg transition-colors">
                  ✕
                </button>
              )}
